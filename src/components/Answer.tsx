    ...
    return (
        ...
        >
            ...
            <AnimatePresence>
                {(shortcut && !revealed) &&
                    <motion.span
                        className={`flex flex-row items-center justify-center text-[0.7rem] border w-4 h-4 rounded font-mono transition ${selected ? "text-white border-white" : "text-neutral-500 border-neutral-500"}`}
